...
{{- define "osie.ui.oauth2ClientId" -}}
{{- required "ui.oauth2.clientId is required" .Values.ui.oauth2.clientId }}
{{- end -}}
...
{{- define "osie.admin.oauth2ClientId" -}}
{{- required "admin.oauth2.clientId is required" .Values.admin.oauth2.clientId }}
{{- end -}}
